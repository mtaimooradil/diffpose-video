...
# from diffpose_video.models.gcnpose import GCNpose, adj_mx_from_edges
...
from diffpose_video.common.utils import *
from diffpose_video.common.utils_diff import get_beta_schedule, generalized_steps
from diffpose_video.common.data_utils import fetch_me, read_3d_data_me, create_2d_data
# from diffpose_video.common.generators import PoseGenerator_gmm
from diffpose_video.common.loss import mpjpe, p_mpjpe

from diffpose_video.common.data_video_utils import *

from diffpose_video.common.camera import *
from diffpose_video.common.loss import *
from diffpose_video.common.generators import ChunkedGenerator_Seq, UnchunkedGenerator_Seq, PoseGenerator_gmm
...
class Diffpose(object):
    ...
    def prepare_mixste_data(self):
        ...
        if config.data.dataset == "human36m":
            from diffpose_video.common.h36m_dataset import Human36mDataset
    ...
    def prepare_Diffpose_data(self):
        ...
        # load dataset
        if config.data.dataset == "human36m":
            from diffpose_video.common.h36m_dataset_diff import Human36mDataset_diff, TRAIN_SUBJECTS
